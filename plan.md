...
- Current next step: po kolejnym cyklu cron: `python scripts/n8n_fleet_health_apr2026.py` + ewentualnie `GET .../executions?...&includeData=true` dla workflowów wciąż `error`; WOW digest VPS 08:00 jak w `rs-n8n-wow-2026`; opcjonalnie smoke `https://rsperformance.online/api/n8n/vertex/*`.
